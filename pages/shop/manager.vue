        ...
        <div id="top-bar">
            <ul class="top-menu">
                <li class="top-item" :class="{active:RegExp(/manager-order/).test($route.name)}">
                    <nuxt-link to="/shop/manager/order">订单管理</nuxt-link>
                </li>
                <!--<li class="top-item" :class="{active:$route.name === 'manager'}">-->
                    <!--<nuxt-link to="/shop/manager/order">查看订单</nuxt-link>-->
                <!--</li>-->
                <!-- <li class="top-item" :class="{active:$route.name === 'manager-mote-id'}">
                    <nuxt-link to="/manager/mote">模特</nuxt-link>
                </li>
                <li class="top-item" :class="{active:$route.name === 'manager-embroidery-id'}">
                    <nuxt-link to="/manager/embroidery">绣花</nuxt-link>
                </li>
                <li class="top-item" :class="{active:$route.name === 'manager-doc'}">
                    <nuxt-link to="/manager/doc">文档</nuxt-link>
                </li> -->
            </ul>
            <ul class="top-right">
...
<script>
	export default {
	  ...
	  computed: {
	    username () {
	  	    return this.$store.state.user.data?this.$store.state.user.data.name:''
	    }
	  },
	  methods: {
