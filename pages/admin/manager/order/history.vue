...
<script>
    ...
    export default {
        ...
        computed: mapState({
            orderList: state => {
                return state.manager.historyList
            },
            page: state => {
                return state.manager.historyPage
            },
            totalRow: state => {
                return state.manager.historyCount
            }
        }),
        mounted() {
            let page = 1
            ...
            this.$store.dispatch('manager/getHistoryList', page).then((e) => {
        ...
        methods: {
            ...
            viewDetail(id) {
                window.location.href = `/admin/manager/order/detail/${id}?page=${this.currentPage}&isHistory=true`
            }
        }
    }
</script>